...
#+DATE: 2022-01-28
#+DESCRIPTION: 在 Linux 网关上屏蔽钉钉、微信等 APP 的几种做法:dnsmasq 域名重定向、iptables 按 IP 段与字符串匹配、路由黑洞、bpf 与 xdp。
#+OPTIONS: ^:nil
* 背景
...
#+ATTR_HTML: :alt mitmproxy 的 TCP 流详情,连接 172.16.95.128:49533 <-> tcpconn.tencent.com:80,红框圈出数据包开头的 00 a5 02 3a 45 08 25
